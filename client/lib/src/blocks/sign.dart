...
class BlockWallSign extends Block {
  ...
  static void register() {
    BlockRegistry.registerBlock("wall_sign_north", new BlockWallSign(
        ...
        ..dataValue(2)
        ..build();
    BlockRegistry.registerBlock("wall_sign_south", new BlockWallSign(
        SignDirection.SOUTH)
        ..collidable = false
        ..solid = false
        ..texture = "planks_oak")
        ...
        ..dataValue(3)
        ..build();
    BlockRegistry.registerBlock("wall_sign_west", new BlockWallSign(
        SignDirection.WEST)
        ..collidable = false
        ..solid = false
        ..texture = "planks_oak")
        ...
        ..dataValue(4)
        ..build();
    BlockRegistry.registerBlock("wall_sign_east", new BlockWallSign(
        SignDirection.EAST)
        ..collidable = false
        ..solid = false
        ..texture = "planks_oak")
